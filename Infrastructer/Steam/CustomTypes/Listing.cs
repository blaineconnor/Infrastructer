...
namespace Infrastructer.Steam.CustomTypes
{
    public class Listing
    {
        ...
        public Listing(string listingData, CultureInfo cultureInfo)
        {
            ...
            var pricingData = getPricing(listingData, cultureInfo);
        ...
        private static Tuple<sType, double?> getPricing(string input, CultureInfo cultureInfo)
        {
